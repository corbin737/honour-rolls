...
{
    border-color: #ff9c0a;
    -webkit-box-shadow: inset 0 1px 1px rgba(0, 0, 0, .075), 0 0 6px #ffdaa3;
            box-shadow: inset 0 1px 1px rgba(0, 0, 0, .075), 0 0 6px #ffdaa3;
}
...
{
    border-color: #b9151b;
    -webkit-box-shadow: inset 0 1px 1px rgba(0, 0, 0, .075), 0 0 6px #ef787c;
            box-shadow: inset 0 1px 1px rgba(0, 0, 0, .075), 0 0 6px #ef787c;
}
...
.btn-warning:active
{
    ...
    background-image: -webkit-radial-gradient(circle, #ff9800 10%, #ffb13d 11%);
    background-image:      -o-radial-gradient(circle, #ff9800 10%, #ffb13d 11%);
    background-image:         radial-gradient(circle, #ff9800 10%, #ffb13d 11%);
    background-repeat: no-repeat;
    -webkit-background-size: 1000% 1000%;
            background-size: 1000%;
    -webkit-box-shadow: 2px 2px 4px rgba(0, 0, 0, .4);
...
{
    border-bottom: none;
    -webkit-box-shadow: inset 0 -2px 0 #ffb13d;
            box-shadow: inset 0 -2px 0 #ffb13d;
}
